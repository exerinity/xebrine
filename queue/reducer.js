 ...
 * @property {import('../types').QueueItem[]} items
 * @property {number} position
 * @property {boolean} shuffled
 * @property {import('../types').QueueItem[] | null} original
 */

/**
 * @typedef {
 *   | { type: 'SET', items: import('../types').QueueItem[], position: number }
 ...
 *   | { type: 'APPLY_SHUFFLE', upcoming: import('../types').QueueItem[] }
 *   | { type: 'JUMBLE', items: import('../types').QueueItem[] }
 *   | { type: 'UNSHUFFLE' }
 *   | { type: 'KEEP_CURRENT' }
 *   | { type: 'CLEAR' }
 * } QueueAction
...
/**
 * @param {import('../types').TrackMeta[]} tracks
 * @returns {import('../types').QueueItem[]}
 */
export function makeItems(tracks) {
